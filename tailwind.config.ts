  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'arcade-gradient':
          'linear-gradient(180deg, hsl(230 50% 3%) 0%, hsl(222 47% 6%) 40%, hsl(250 40% 8%) 100%)',
      },
      borderRadius: {
        lg: 'var(--radius)',
      ...
      colors: {
        ...
        'arcade-bg': 'hsl(var(--arcade-bg))',
        'arcade-bg-deep': 'hsl(var(--arcade-bg-deep))',
        chart: {
          '1': 'hsl(var(--chart-1))',
          '2': 'hsl(var(--chart-2))',
          '3': 'hsl(var(--chart-3))',
      ...
      keyframes: {
        ...
        'glow-pulse': {
          '0%, 100%': { boxShadow: '0 0 8px hsl(var(--neon-cyan) / 0.3)' },
